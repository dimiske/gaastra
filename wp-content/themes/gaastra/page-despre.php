...
<div class="row">
	<div class="col-lg-12 p-a-0 m-l-0 m-r-0">
		<div class="container aria-section">
			<div class="row">
				...
				<div class="col-sm-12 col-md-6 col-lg-6 text-center">
					<div class="vertical-container">
						<h3>Apă</h3>
						<p class="paragraph-big">Materiale impermeabile, cusături sigilate.</p>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-sm-12 col-md-6 col-lg-6 text-center">
					<div class="vertical-container">
						<h3>Vânt</h3>
						<p class="paragraph-big">Materiale cu rezistenţă crescută la vânt.</p>
					</div>
				</div>
				<div class="col-sm-12 col-md-6 col-lg-6">
					<figure>
			...
			<div class="row">
				...
				<div class="col-sm-12 col-md-6 col-lg-6 text-center">
					<div class="vertical-container">
						<h3>Temperatură</h3>
						<p class="paragraph-big">Materiale subţiri, cu transfer termic foarte mic.</p>
					</div>
				</div>
			</div>
		</div>
...
<div class="container">
	...
	<div class="row">
		<div class="col-lg-12 p-a-0 m-l-0 m-r-0 text-center">
			<p class="paragraph-big">Istoria Gaastra a început în 1897, când Douwe Gaastra a pus bazele companiei sale de navigaţie în Seek, Olanda. Ambiţia lui a fost să facă navigaţia mai rapidă, competitivă şi eficientă. La scurt timp, Gaastra a devenit un nume comun în lumea globală de navigaţie.</p>
		</div>
	</div>
	<div class="row padding-small">
		<div class="col-sm-12 col-md-6 col-lg-6 m-l-0 m-r-0 text-center">
			<figure>
				<img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/despre/despre-image-5.jpg" class="img-responsive">
			</figure>
		</div>
		<div class="col-sm-12 col-md-6 col-lg-6 m-l-0 m-r-0 text-center">
			<p class="paragraph-big">Este o linie subţire între frică şi pasiune. Douwe Gaastra şi-a pierdut inima printre valuri, dedicându-se creeării celui mai bun echipament de navigaţie. A ştiut că o confruntare cu marea este despre respect şi a fost copleşit de dragoste pentru apele măreţe. Chiar şi în această zi noi respectăm, iubim şi urmărim moştenirea lăsată de Douwe.</p>
		</div>
	</div>
</div>
		...
		<div class="row">
			<div class="col-sm-12 col-md-8 col-lg-8 p-a-0 m-r-0 m-l-0 text-center">
				<div class="padding-small">
					...
					<p class="paragraph-big">Înfiinţarea companiei de navigaţie de către Douwe Gaastra în Seek, Olanda.</p>
				</div>
				<div class="padding-small">
					<p class="years">1970</p>
					<p class="paragraph-big">Între 1970 şi 1990 Gaastra este recunoscut ca un brand prestigios de windsurfing.</p>
				</div>
				<div class="padding-small">
					<p class="years">1996</p>
					<p class="paragraph-big">Primele linii de articole de îmbrăcăminte - Gaastra Pro şi Gaastra Sportwear.</p>
				</div>
				<div class="padding-small">
					<p class="years">2000</p>
					<p class="paragraph-big">Gaastra devine parte a McGregor Fashion Group B.V., grup înfiinţat în anul 1993.</p>
				</div>
				<div class="padding-small">
					<p class="years">2005</p>
					<p class="paragraph-big">Gaastra devine sponsor al celui mai prestigios eveniment de navigaţie, şi anume Les Voiles de St. Tropez.</p>
				</div>
				<div class="padding-small">
					<p class="years">2010</p>
					<p class="paragraph-big">Gaastra ajunge în ţările Scandinave şi deschide primul magazin în Italia. În acelaşi an, Gaastra devine unul dintre principalii sponsori asociaţi cu SAIL 2010 şi începe un parteneriat de sponsorizare cu The Jethou, un iacht de curse.</p>
				</div>
				<div class="padding-small">
					<p class="years">2011</p>
					<p class="paragraph-big">Gaastra deschide primul magazin în SUA, în Newport, Rhode Island. Tot atunci, Gaastra devine sponsor oficial al Les Voiles de Saint Barth şi partener oficial al muzeului Scheepvaartmuseum.</p>
				</div>
				<div class="padding-small">
					<p class="years">2012</p>
					<p class="paragraph-big">Gaastra devine partener oficial al evenimentului internaţional B44 Barcelona, în golful Trieste din partea nordică a Mării Mediterane şi deschide primul său sediu central în Amsterdam, Olanda.</p>
				</div>
				<div class="padding-small">
					<p class="years">2013</p>
					<p class="paragraph-big">Pentru al patrulea an consecutiv, Gaastra este partener şi sponsor oficial de îmbrăcăminte pentru Copa del Rey.</p>
				</div>
				<div class="padding-small">
					<p class="years">2014</p>
					<p class="paragraph-big">Gaastra îşi deschide uşile primului magazin din România, în Cluj-Napoca.</p>
				</div>
			</div>
	...
	<div class="row">
		...
		<div class="col-sm-12 col-md-4 col-lg-4 p-a-0 m-l-0 m-r-0 text-center module">
			...
			<div class="circle">
				...
				<span class="big-number">1.500</span>
			</div>
			<p>MAGAZINE <br>disponibile în întreaga lume</p>
		</div>
	</div>
</div>
