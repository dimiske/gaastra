...
while ( have_posts() ) : the_post(); ?>
    <article class="row banner-item p-a-0 m-l-0  m-r-0" style="margin-bottom: 40px;">
        ...
        ?>
        <div class="intro col-lg-12 col-sm-12 col-xs-12 text-center p-a-0 m-l-0  m-r-0" style="background: url('<?php echo the_field('banner_image'); ?>') no-repeat center top;no-repeat center center fixed; -webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; background-size: cover; height: 500px;">
            <div class="container">
